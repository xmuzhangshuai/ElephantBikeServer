...
public class BGetAllOrder extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<Order> model = new GridDataModel<Order>();
		// pageStr页码
		...
		int total = iOrderService.getOrderCount(queryParams);
		...
		model.setRows(iOrderService.findForPage(start, end, sortStr, orderStr,
				queryParams));
