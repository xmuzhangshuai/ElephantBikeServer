...
/**
 * Servlet implementation class BGetUserData
 */
@WebServlet("/getuserdata")
public class BGetUserData extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		GridDataModel<UserData> model = new GridDataModel<UserData>();
		// pageStr页码
		...
		int total = iUserService.getUserDataCount(queryParams);
		...
		model.setRows(iUserService.getUserData(start, end, sortStr, orderStr,
				queryParams));
